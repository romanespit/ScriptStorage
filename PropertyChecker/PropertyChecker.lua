...
function onScriptTerminate(scr, is_quit)
	if scr == thisScript() and not is_quit and not reloaded then
        tech_sms("Ñêğèïò íåïğåäâèäåííî âûêëş÷èëñÿ! Ïğîâåğüòå êîíñîëü SAMPFUNCS.")
	end
end
------------------------ Script Commands
...
function main()
	...
	tech_sms("Óñïåøíàÿ çàãğóçêà ñêğèïòà. Èñïîëüçóéòå: ".. COLOR_MAIN .."/"..MAIN_CMD.."{FFFFFF}. Àâòîğ: "..COLOR_MAIN..table.concat(scr.authors, ", ")) -- Ïğèâåòñòâåííîå ñîîáùåíèå
